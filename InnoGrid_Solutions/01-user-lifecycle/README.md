...
| `design.md` | Identity source decision tree, joiner/mover/leaver process flows, group/permission set design, compliance mapping (SOC 2, ISO 27001) |
...
- Kevin Nguyen deactivated: all groups removed, user disabled in IAM Identity Center, CISO notified
